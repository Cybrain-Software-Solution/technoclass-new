$(function() {
    ...
    $.each($(".owl-product-gallery"), function(i, n) {
        $(n).owlCarousel({
          ...
          rewindNav: true, // Enable navigation loop
          rewindSpeed: 800, // Set the rewind speed
          afterInit: function(elem) {
            // Add custom event listener for mouse drag
            $(elem).find(".owl-wrapper").on("mousedown.disableTextSelect", function() {
              return false;
            });
          }
        });
